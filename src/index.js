...
import { fireGirl, uh, mountainsTrees, bark, clouds, sky, branches, sun } from './tiles/imageTiles/index.js';
...
const tile = Tile.above(
  Tile.above(
    Tile.beside(
      Tile.counterclockwise(branches),
      sky,
    ),
    Tile.beside(
      sky,
      ...
      Tile.above(
        sky,
        sky,
        Tile.beside(sky, bark),
      ),
      bark,
      sun,
      Tile.clockwise(branches),
      sky,
      sky,
      sky,
      sky,
